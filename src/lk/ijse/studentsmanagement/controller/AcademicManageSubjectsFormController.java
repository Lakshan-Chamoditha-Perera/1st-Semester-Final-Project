...
public class AcademicManageSubjectsFormController implements Initializable {
    ...
    void btnAddSubjectOnAction(ActionEvent event) {
        try {
            if (txtSubID.getText() != null) {
                if (txtSubName.getText() != null) {
                ...
                lblInvalidSubID.setVisible(true);
                txtSubID.setFocusColor(javafx.scene.paint.Color.RED);
            }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        lblInvalidSubID.setVisible(false);
    ...
    private void refreshTable() throws SQLException, ClassNotFoundException {
        TableLoader.loadSubjectTable((TableView<SubjectTM>) tblSubjects);
    }

    public void txtSubIdOnMuseClicked(MouseEvent mouseEvent) {
        lblInvalidSubID.setVisible(false);
    }

...
public class CourseModel {
    ...
    public static Course getCourseDetail(String value) throws SQLException, ClassNotFoundException {
        ResultSet resultSet = CrudUtil.execute("SELECT * FROM course WHERE id = ?", value);
        Course course = null;
        if(resultSet.next()){
             course = new Course(
                    resultSet.getString(1),
